...
| 7 | {doc}`tables/ObservationMeasurementResult` |
| 8 | {doc}`tables/MOEResultInline` |
| 9 | {doc}`tables/MOEResultExternal` |
...
| 14 | {doc}`tables/SRSInline` |
| 15 | {doc}`tables/SRSExternal` |
...
| 23 | {doc}`tables/ObservationMeasurementResultPNSD` |
